...
const problems = [
  { icon: '家', title: '自分の家がいくらで売れるのか知りたい', text: '売る前の段階から、現実的な選択肢を整理します。' },
  { icon: '相', title: '相続した不動産をどうすればいいかわからない', text: '売却・賃貸・保有を比較して、進め方を一緒に考えます。' },
  { icon: '住', title: '住み替えを検討しているがタイミングが不安', text: '購入と売却の順番、資金計画まで確認します。' },
  { icon: '空', title: '空き家の管理や売却に困っている', text: '放置リスクや売却時期も含めてご案内します。' }
];
